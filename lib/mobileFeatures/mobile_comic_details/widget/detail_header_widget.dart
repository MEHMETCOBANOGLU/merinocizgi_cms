  ...
  Widget build(
    ...
    return seriesAsync.when(
      data: (doc) {
        ...
        final synopsis = data['synopsis'] ?? data['summary'] ?? '';
        final urlImage = data['coverImageUrl'] ?? data['squareImageUrl'] ?? '';
        ...
        final textPainter = TextPainter(
          ...
          maxLines: isReadMore
              ? 1000
              : 3, // "Daha fazla" modunda satır limiti olmasın
        )..layout(
            maxWidth: size.width * 0.9 - 32); // Container genişliği - padding
