...
class PopularSeriesByCategoryWidget extends ConsumerStatefulWidget {
  // Dışarıdan artık sadece başlık alıyor.
  const PopularSeriesByCategoryWidget({super.key});

  @override
  ConsumerState<PopularSeriesByCategoryWidget> createState() =>
      _CarouselCategoryWidgetState();
}

class _CarouselCategoryWidgetState
    extends ConsumerState<PopularSeriesByCategoryWidget> {
        ...
        return Column(
          ...
          children: [
            ...
            nonEmptyCategoriesAsync.when(
              ...
              error: (e, st) =>
                  Center(child: Text("Kategoriler yüklenemedi: $e")),
            ),
